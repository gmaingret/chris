...
**Plans**: 4 plans
  ...
  - [ ] 23-02-PLAN.md — `scripts/backfill-episodic.ts` operator script (OPS-01)
...
| 23. Test Suite + Backfill + /summary | v2.2    | 1/4   | In progress | -          |
