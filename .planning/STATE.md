...
status: in_progress
stopped_at: v2.2 M008 milestone started — defining requirements
...
**Current focus:** v2.2 M008 Episodic Consolidation — building end-of-day summary tier above the raw Pensieve, with importance scoring and recency-routed retrieval.
...
Last activity: 2026-04-18 — Milestone v2.2 M008 Episodic Consolidation started
...
None. M008 spec in `M008_Episodic_Consolidation.md` is canonical. Confirmed M007 has had ≥2 weeks of real Telegram use before starting M008.

## Session Continuity

Last session: 2026-04-18 — milestone v2.2 M008 started
...
- **TECH-DEBT-19-01** — `src/db/migrations/meta/0001_snapshot.json` and `0003_snapshot.json` missing.
  ...
  - **Reactivation trigger:** the next phase that modifies `src/db/schema.ts` (adding a table/column/enum). M008 adds `episodic_summaries` table — this trigger is now active and the regeneration must happen as part of M008's first schema-touching phase.
